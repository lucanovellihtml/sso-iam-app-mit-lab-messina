...
<div class="mt-4 mt-sm-0">
    ...
    <div class="d-flex gap-1">
        ...
        <svg style="fill: #06c !important;" class="icon icon-sm icon-primary" data-bs-container="body"
            ...
            title=""
            data-bs-content="<div><b>SPID TIPO 2</b> - Identità digitale della persona giuridica</div><div><b>SPID TIPO 3</b> - Identità digitale ad uso professionale della persona fisica</div><div><b>SPID TIPO 4</b> - Identità digitale ad uso professionale della persona giuridica</div>"
            data-original-title="">
